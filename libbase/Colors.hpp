...
On old builds (Windows 10 1909 or prior) Windows just recognize the ESC code 1, but it is possible for Windows to recognize the ESC code \033 (or other depending on the language) with a modification in the record (regedit.exe).
